...
if __name__ == '__main__':
    ...
    parser.add_argument('-f', '--pathToFiles', default='', type=str, help='Specify path to folder containing the '
                                                                          'ExpressionData.csv file generated by the '
                                                                          'BoolODE simulation.')
    ...
    print("Predicted %d predominant states with a right-most index of %s."
    ...
    if do_k_means:
        if cyclic_behavior:
            ...
            while True:
                try:
                    use_num_steady_states = input("There are %d called steady states. Would you like to use this "
                                                  "value for the number of clusters? (yes or no): "
                                                  % num_steady_states)
