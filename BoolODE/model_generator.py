...
class GenerateModel:
    ...
    def readBooleanRules(self):
        ...
        for n in self.withoutRules:
            # if not self.parameterInputsDF.empty and n in self.parameterInputsDF['Input']:
            if not self.parameterInputsDF.empty and n in self.parameterInputsDF.values:  # JON TEST CODE
